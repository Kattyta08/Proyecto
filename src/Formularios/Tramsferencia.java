...
public class Tramsferencia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(fecha_transferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 340, 110, 30));
    ...
    private void btcalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btcalcularActionPerformed
        ...
        double cotizacion=(((Double.parseDouble(txtValor.getText()))*(Integer.parseInt(txtporcentaje.getText()))/100));
